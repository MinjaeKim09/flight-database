...
def main():
    ...
    try:
        ...
        print("Starting database reset for DEMO...")
        drop_all(cur)
        
        run_sql_file(cur, "Create Tables.sql")
        # CHANGED: Loading test_scenario_data.sql instead of Insertion Data.sql
        run_sql_file(cur, "test_scenario_data.sql")
        
        conn.commit()
        print("Database reset and populated with DEMO DATA successfully!")
